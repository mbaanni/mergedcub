...
CC= cc
SRC= main.c event.c maps.c calculation.c draw_line.c draw_mini_map.c
PRC= check_elemnts.c free_elements.c  linkedlist_utils.c map_parsing.c singelton_object.c
NAME= Cub3d
DIR_SRC = src/
DIR_PRC = parser/
DIR_OBG = obj/
